        ...
        <div className={style.main_wrapper}>
            <div className={style.container}>
                ...
                <form action="" id="form" onSubmit={handleSubmit} className={`${style.form}`}>
                    ...
                    <div className={style.error_form}>{errors.name && <p>{errors.name}</p>}</div> {/*error de nombre*/}
                    ...
                    <div className={style.error_form}>{errors.height && <p>{errors.height}</p>}</div>{/* error */}
                    ...
                    <div className={style.error_form}>{errors.weight && <p>{errors.weight}</p>}</div>{/* error */}

                    <div className="life-span-container">
                        <input type="text" autoComplete="off" name="life_span" value={form.life_span} placeholder="lifespan example: 8 - 16" onChange={(e) => handleChange(e)}/>
                    </div>
                    <div className={style.error_form}>{errors.life_span && <p>{errors.life_span}</p>}</div>{/* error */}
                    ...
                    <div className={""}>
                        <select className={style.select_temperaments} onChange={handleSelect}>
                            ...
                            {temperaments.map(d => (                    
                                <option value={d.name} key={d.name+Math.random()} className={style.option_temperament}>{d.name}</option> //key de elementos de temperamentos, eliminar el repetido 
                            ))}
                        </select>
                    </div>
